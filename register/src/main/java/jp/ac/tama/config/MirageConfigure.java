...
import jp.ac.tama.RegisterApplication;
 ...
 */
@Configuration
@EnableMirageRepositories(basePackageClasses = RegisterApplication.class,sqlManagerRef = "sqlManager")
public class MirageConfigure {
    @Autowired
    DataSourceTransactionManager dataSourceTransactionManager;
    @Bean
    public SqlManagerImpl sqlManager() {
        // bridge java.util.logging used by mirageist
